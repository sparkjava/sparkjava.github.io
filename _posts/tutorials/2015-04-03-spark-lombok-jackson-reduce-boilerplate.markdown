...
<img class="img-bordered" src="/img/tutorials/posts/postman1.png" alt="Testing with Postman">
...
<img class="img-bordered" src="/img/tutorials/posts/postman2.png" alt="Testing with Postman">
