...
{% capture code %}{% include tutorials/codeExamples/herokuDeploy/maven.xml %}{% endcapture %}{{ code | xml_escape }}
</code></pre>
...
<pre><code class="language-markup">
{% capture code %}{% include tutorials/codeExamples/herokuDeploy/heroku.xml %}{% endcapture %}{{ code | xml_escape }}
</code></pre>
