...
<img class="img-bordered" src="/img/tutorials/posts/postman_2_1.png" alt="Testing with Postman">
...
<img class="img-bordered" src="/img/tutorials/posts/postman_2_2.png" alt="Testing with Postman">

Now asking again for the list of posts we should be able to get a list of one element: the post we just inserted

<img class="img-bordered" src="/img/tutorials/posts/postman_2_3.png" alt="Testing with Postman">
...
<img class="img-bordered" src="/img/tutorials/posts/postman_2_4.png" alt="Testing with Postman">
...
<img class="img-bordered" src="/img/tutorials/posts/postman_2_5.png" alt="Testing with Postman">
